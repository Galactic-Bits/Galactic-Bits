...
function usage()
{
    ...
    echo "and generates the checksum files of the GalacticBits tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/GalacticBits/GalacticBits.git"
CLONE_DIR="$BUILD_DIRECTORY/GalacticBits-buildall"
TARGET_DIR="$BUILD_DIRECTORY/GalacticBits-releases"
DYNAMIC_RELEASE="GalacticBits-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="GalacticBits-${TAG_VERSION}-linux-staticboost-CLI"
